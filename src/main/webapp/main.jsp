...
<div id="main">
  ...
  <%--          <div class="col s12 m4">
            ...
            <div class="col s12 m4">
                <div class="card">
                    <div class="card-image waves-effect waves-block waves-light my-opacity">
                        <a href="<s:url action="studentscorelist"/>"><img class="activator" src="images/questiontype2.jpg"></a>
                    </div>
                    <div class="card-content">
                        <a href="<s:url action="studentscorelist"/>">
		                    <span class="card-title activator light-green-text text-darken-4">积分统计
		                    <i class="fas fa-sign-in-alt fa-lg right light-green-text"></i></span></a>
                        <p><a href="<s:url action="studentscorelist"/>">个人积分统计</a></p>
                    </div>
                </div>
            </div>
            </s:if>
                ...
                <div class="col s12 m4">
                    <div class="card">
                        ...
                        <div class="card-content">
		                    ...
		                    <i class="fas fa-sign-in-alt fa-lg right light-green-text"></i></span></a>
                            <p><a href="statsTypes.jsp">统计分析</a></p>
                        </div>
                    </div>
                </div>
            </s:if>
